          ...
          <div class="card shadow">
            ...
            <div class="card-body">
                ...
                <form action="{{ url('/pacientes/'.$patient->id) }}" method="POST">
                    ...
                    <input type="text" name="email" id="description" class="form-control" value="{{ old('email', $patient->email)}}" required>
                    </div>

                    <div class="form-group">
                    <label for="description">DPI</label>
                    <input type="text" name="dpi" id="description" class="form-control" value="{{ old('dpi', $patient->dpi)}}" required>
                    </div>

                    <div class="form-group">
                    <label for="description">Direccion</label>
                    <input type="text" name="address" id="description" class="form-control" value="{{ old('address', $patient->address)}}" required>
                    </div>

                    <div class="form-group">
                    <label for="description">Telefono</label>
                    <input type="text" name="phone" id="description" class="form-control" value="{{ old('phone', $patient->phone)}}" required>
                    </div>
